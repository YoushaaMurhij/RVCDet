...
def main():
    cfg = Config.fromfile('configs/nusc/pp/nusc_rvcdet_pp_02voxel_two_pfn_10sweep_demo.py')
    ...
    checkpoint = load_checkpoint(model, 'work_dirs/rvcdet_pillar_512_demo/latest.pth', map_location="cpu")
    model.eval()
